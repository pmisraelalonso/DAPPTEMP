// Mock data for Dynamic DApp - Gaming & DeFi Platform
...
const initializeMockData = () => {
  ...
  mockData.governanceProposals = [
    ...
    },
    {
      ...
      description: 'Proposal to add Dynamic-BTC liquidity pool',
      category: 'DeFi',
      status: 'pending',
      creator: 'user_002',
  ...
  // Market Data
  mockData.marketData = {
    // Flat properties for API compatibility
    totalUsers: 12500,
    ...
    totalNFTs: 45000,
    dynamicPrice: 2.45,
    dynamicMarketCap: 24500000,
    dynamicCirculatingSupply: 10000000,
    dynamicTotalSupply: 100000000,
    // Nested structure
    dynamic: {
      price: 2.45,
      change24h: 5.2,
  ...
  mockData.transactions = [
    ...
    },
    {
      ...
      metadata: {
        poolName: 'Dynamic-ETH',
        tokens: { dynamic: 500, eth: 0.5 }
      }
    }
  ];
