...
router.get('/overview', (req, res) => {
  try {
    ...
    const overview = {
      ...
      tokenomics: {
        dynamicPrice: marketData.dynamicPrice,
        dynamicMarketCap: marketData.dynamicMarketCap,
        dynamicCirculatingSupply: marketData.dynamicCirculatingSupply,
        dynamicTotalSupply: marketData.dynamicTotalSupply,
        priceChange24h: 5.2,
        priceChange7d: 12.8,
        priceChange30d: -3.5
      },
...
router.get('/market-data', (req, res) => {
  try {
    ...
    const realTimeData = {
      timestamp: new Date().toISOString(),
      dynamic: {
        price: marketData.dynamic.price + (Math.random() - 0.5) * 0.1,
        change24h: 5.2,
        volume24h: 2500000,
        marketCap: marketData.dynamic.marketCap,
        circulatingSupply: marketData.dynamicCirculatingSupply
      },
      topTokens: [
        { symbol: 'Dynamic', price: 0.85, change24h: 5.2, volume: 2500000 },
      ...
      trending: [
        { symbol: 'Dynamic', volume: 2500000, change: 5.2 },
