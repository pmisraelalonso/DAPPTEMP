// WebSocket handlers for Dynamic DApp - Real-time updates and notifications
...
const setupWebSocketHandlers = (ws) => {
  ...
  ws.send(JSON.stringify({
    type: 'connection',
    message: 'Connected to Dynamic DApp WebSocket server',
  ...
  const mockNotifications = [
    {
      ...
      message: 'You earned 150 Dynamic tokens from Crypto Warriors!',
      timestamp: new Date().toISOString(),
      read: false
    },
    {
      ...
      message: 'Dynamic-ETH pool now offers 48.5% APY!',
      timestamp: new Date().toISOString(),
      read: false
    }
  ];
