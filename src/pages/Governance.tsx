...
const proposals = [
  {
    ...
    description: "Proposal to increase the daily gaming rewards pool from 1M to 1.5M Dynamic tokens",
    status: "Active",
    votesFor: "12.5M",
    votesAgainst: "2.1M", 
    timeLeft: "3 days",
          ...
          <div className="container mx-auto text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Shape the future of Dynamic through decentralized governance and community voting
              </p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm">
                          <span>For: {proposal.votesFor} Dynamic</span>
                          <span>Against: {proposal.votesAgainst} Dynamic</span>
                        </div>
                        ...
                        <div className="flex justify-between text-sm text-muted-foreground">
                          <span>Quorum: {proposal.quorum} Dynamic</span>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Token holders vote with their Dynamic tokens as voting power
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 gradient-accent rounded-full flex items-center justify-center mx-auto mb-4">
